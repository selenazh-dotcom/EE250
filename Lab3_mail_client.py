...
def get_inbox(recipient: str) -> None:
    ...
    This function prints out all the mail in the inbox of a certain recipient.

    Input:
        recipient, string

    Returns:
        nothing, but prints mail
    """
...
def get_sent(sender: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
     This function prints out all the mail in the sent of a certain sender.
...
def get_mail(mail_id: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    This function prints out a mail specified by a given mail_id.
...
def delete_mail(mail_id: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
     This function deletes the mail specified by a given mail_id.

    Input:
        mail_id, string

    Returns:
        nothing, but prints mail that is deleted
    """
