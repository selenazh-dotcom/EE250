...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("selenazh/ipinfo")
    client.subscribe("selenazh/dateinfo")
    client.subscribe("selenazh/timeinfo")
        
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("selenazh/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("selenazh/dateinfo", on_message_from_dateinfo)
    client.message_callback_add("selenazh/timeinfo", on_message_from_timeinfo)
