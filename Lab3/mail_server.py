...
def save_mail(mail: List[Dict[str, str]]) -> None:
    ...
    This function converts the contents of the mail into a json file 'mail_db.json and saves it into a chosen directory. 
    Input:
        mail, list of mail dictionaries that you want to save
...
def add_mail(mail_entry: Dict[str, str]) -> str:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This function loads existing pieces of mail and appends the inut mail_entry to the end. It then saves the mail with the newly appended bit, and generates an id for the mail entry.

    Input:
        mail_entry, string dictionary of what you want to append

    Returns:
        mail_entry['id], string of the generated unique id
    """
    mail = load_mail()
...
def delete_mail(mail_id: str) -> bool:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This function takes in a specified mail_id and removes it from the list of mails. It then saves the mail list with that piece removed.

    Input:
        mail_id, string, of what you want removed

    Returns:
        boolean of whether the mail was found and deleted
...
def get_mail(mail_id: str) -> Optional[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This function takes in a specified mail_id and returns the corresponding dictionary if it is found.

    Input:
        mail_id, string of what you want returned

    Output:
        (optional) mail dictionary, if found
...
def get_inbox(recipient: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This function finds all the mail that corresponds to a certain recipient and returns it into a dictionary list inbox

    Input:
        recipient, string

    Returns:
        inbox, dictinoary list of corresopnding mail
...
def get_sent(sender: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
     This function finds all the mail that corresponds to a certain sender and returns it into a dictionary list inbox
...
def get_sent_route(sender: str):
    """
    Summary: Gets all mail entries for a sender from the hson file
